...
class GenericDataPreparatorSpec extends Specification {
  ...
  appdataUsers.insert(ltuser.copy(id = "u1"))
  appdataUsers.insert(ltuser.copy(id = "u2"))
  appdataUsers.insert(ltuser.copy(id = "u3"))
  ...
  appdataItems.insert(ltitem.copy(id = "i1", itypes = List("t1", "t2")))
  appdataItems.insert(ltitem.copy(id = "i2", itypes = List("t1")))
  appdataItems.insert(ltitem.copy(id = "i3", itypes = List("t2", "t3")))
  appdataItems.insert(ltitem.copy(id = "i4", itypes = List("t3")))
  ...
  // test mixed and conflict actions
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i1", action = "view"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i1", action = "rate", v = Some(3)))
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i2", action = "rate", v = Some(4)))
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i3", action = "rate", v = Some(1)))

  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i1",
    action = "add-to-closet"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i2",
    action = "add-to-closet"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i3",
    action = "add-to-closet"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i2",
    action = "remove-from-closet"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i3",
    action = "remove-from-closet"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i1",
    action = "add-to-closet"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i2",
    action = "add-to-closet"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u1", iid = "i4",
    action = "add-to-closet"))

  appdataU2IActions.insert(ltu2i.copy(uid = "u2", iid = "i1", action = "view"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u2", iid = "i1", action = "rate", v = Some(2)))
  appdataU2IActions.insert(ltu2i.copy(uid = "u2", iid = "i2", action = "view"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u2", iid = "i2", action = "rate", v = Some(5)))
  appdataU2IActions.insert(ltu2i.copy(uid = "u2", iid = "i2", action = "rate", v = Some(1)))
  appdataU2IActions.insert(ltu2i.copy(uid = "u2", iid = "i4", action = "dislike"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u2", iid = "i4", action = "rate", v = Some(3)))

  appdataU2IActions.insert(ltu2i.copy(uid = "u3", iid = "i2", action = "like"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u3", iid = "i2", action = "rate", v = Some(5)))
  appdataU2IActions.insert(ltu2i.copy(uid = "u3", iid = "i3", action = "view"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u3", iid = "i3", action = "view"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u3", iid = "i3", action = "rate", v = Some(1)))
  appdataU2IActions.insert(ltu2i.copy(uid = "u3", iid = "i4", action = "view"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u3", iid = "i4", action = "rate", v = Some(4)))

  // unknown user and item actions (not exist in user and items appdata)
  appdataU2IActions.insert(ltu2i.copy(uid = "u3", iid = "i5", action = "view"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u3", iid = "i6", action = "rate", v = Some(4)))
  appdataU2IActions.insert(ltu2i.copy(uid = "u4", iid = "i2", action = "view"))
  appdataU2IActions.insert(ltu2i.copy(uid = "u4", iid = "i1", action = "rate", v = Some(3)))

  "LTGenericDataPreparator with matrixMarket = true" should {

    val outputDir = s"${parentDir}/ltmmtrue"
    val args = Map(
      "outputDir" -> outputDir,
      "appid" -> ltappid,
      "viewParam" -> 4,
    ...
    LTGenericDataPreparator.main(argsArray)
    ...
    "correctly generate closet.csv" in {
      val closetLines = Source.fromFile(s"${outputDir}closet.csv").getLines
        .toSeq
      val expected = Seq("1,1", "1,2", "1,4")
      closetLines must containTheSameElementsAs(expected)
    }

  }

  "LTGenericDataPreparator with matrixMarket = false" should {

    val outputDir = s"${parentDir}/ltmmfalse"
    val args = Map(
      "outputDir" -> outputDir,
      "appid" -> ltappid,
      "viewParam" -> 4,
  ...
  "LTGenericDataPreparator with matrixMarket = false and seenAction" should {

    val outputDir = s"${parentDir}/ltseenActions"
    val args = Map(
      "outputDir" -> outputDir,
      "appid" -> ltappid,
      "viewParam" -> 4,
